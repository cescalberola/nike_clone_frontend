        ...
        <header className="pre-l-header top-stack-context" data-pre="Header">
            <div className="pre-l-wrapper mauto-sm d-sm-flx">
                <div className="pre-l-logo prl0-sm top-stack-context" data-var="swooshLogo">
                    <a aria-label="Nike Home Page" data-brand="nike" data-type="click_headerLogo" data-path="home" href="https://www.nike.com" className="d-sm-b pre-logo-link" data-pre="ILink">
                        ...
                        <div className="pre-l-search-box">
                            <div className="d-sm-flx flx-jc-lg-fe u-position-rel">
                                <div className="pre-search-contain">
                                    <div className="pre-search-input-box d-sm-b flx-dir-lg-c flx-ai-lg-fe d-lg-flx flx-gro-sm-1 flx-gro-lg-0" type="search">
                                        <input type="text" id="VisualSearchInput" className="pre-search-input headline-5" name="search"
                                            // autocomplete="off" tabindex="0" 
                                            data-var="vsInput" placeholder="Search" aria-label="Search Products" role="combobox" aria-controls="VisualSearchSuggestionsList" aria-owns="VisualSearchSuggestionsList" aria-expanded="false" />
                            ...
                            <div className="pre-l-vs-box ta-sm-l" data-var="vsContainer">
                                <div className="pre-l-vs-popular pl9-sm pr5-sm prl0-lg mauto-sm" data-var="vsPopularTerms" data-pre="VisualSearchPopularTerms">
                                    ...
                                    <ul>
                                        <li>
                                            <a rel="nofollow" data-type="click_popularSearchSelection"
                                                // tabindex="0" 
                                                data-path="Air Force 1" href="https://www.nike.com/w/air-force-1-shoes-5sj3yzy7ok?vst=Air%20Force%201" className="pre-l-vs-popular-term ncss-cta-primary-dark ta-sm-l d-sm-b mb3-sm" data-pre="ILink">Air Force 1</a>
                                        </li>
                                        <li>
                                            <a rel="nofollow" data-type="click_popularSearchSelection"
                                                // tabindex="0" 
                                                data-path="Jordan" href="https://www.nike.com/w/jordan-37eef?vst=Jordan" className="pre-l-vs-popular-term ncss-cta-primary-dark ta-sm-l d-sm-b mb3-sm" data-pre="ILink">Jordan</a>
                                        </li>
                                        <li>
                                            <a rel="nofollow" data-type="click_popularSearchSelection"
                                                // tabindex="0" 
                                                data-path="Air Max" href="https://www.nike.com/w/air-max-shoes-a6d8hzy7ok?vst=Air%20Max" className="pre-l-vs-popular-term ncss-cta-primary-dark ta-sm-l d-sm-b mb3-sm" data-pre="ILink">Air Max</a>
                                        </li>
                                        <li>
                                            <a rel="nofollow" data-type="click_popularSearchSelection"
                                                // tabindex="0" 
                                                data-path="Blazer" href="https://www.nike.com/w/blazer-shoes-9gw3azy7ok?vst=Blazer" className="pre-l-vs-popular-term ncss-cta-primary-dark ta-sm-l d-sm-b mb3-sm" data-pre="ILink">Blazer</a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div className="pre-mobile-exposed-search-box" data-var="mobileHeaderSearchInput" data-pre="MobileHeaderSearchInput">
                <button className="pre-mobile-exposed-search-button headline-5" type="text" name="search"
                    // autocomplete="off" 
                    data-var="vsMobileHeaderInput" aria-label="Search Products">Search</button>
